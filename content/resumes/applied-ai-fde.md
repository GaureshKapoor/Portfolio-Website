# Resume — Applied AI / FDE

**Status:** FINAL as of August 2026. This is the primary track — the site and the rest of `content/` follow it.
...
**Bullet discipline:** ~150–180 characters (one and a half lines). Exponent's FDE examples run 160–185; SWE resumes run 105–120. Past ~200 it stops scanning.
...
- Developed a real-time retrieval interface between GenAI agents and LLM systems, reducing issue-resolution time by 25%.
- Analyzed 50M+ customer records in Python/SQL across GTM analytics initiatives for an apparel brand, identifying operational and product opportunities that contributed to an 8% improvement in monthly P&L.

**ClearTax India** — New Delhi, India
...
**Vault** — Founder & Product Engineer | joinvault.app · December 2025 – March 2026

- Shipped a full-stack AI platform for agentic ideation, task-planning and execution built on Next.js, Supabase, and Vercel.
- Architected core systems across auth, data models, agent flows, billing (Stripe), analytics, and product UX from 0 to 1.

**Ionava** — Financial Health & Wellness Platform backed by Angel Investors | Link · September 2025 – December 2025
...
Bruin Finance Society and DataRes Consulting were cut from this version for space — both belong on `strategy-ops-growth.md`.
